...
import { Card, Col, Nav, OverlayTrigger, Modal, Table, Tooltip, Button, Form } from "react-bootstrap";
...
export default function BestProductCtrl() {
  ...
  const fetchPopData = () => {
    ...
    axios.get('http://localhost:3000/api/best-products') // Replace with your API endpoint
      .then((response) => {
...
const handleProductChange = (e) => {
  ...
  const handleNewStatus = () => {
    ...
    axios.put(`http://localhost:3000/api/best-products/${selectedProduct}`, {
      best_status: 1 // or 0, depending on your use case
  })
    .then((response) => {
...
const handleDeleteProduct = () => {
  axios.put(`http://localhost:3000/api/del-best-products/${productToDelete.product_id}`, {
    best_status: 0 // or 0, depending on your use case
})
  .then((response) => {
      // Handle the response accordingly (if needed)
      console.log('Product updated successfully:', response.data);
      ...
      <div className="main main-app p-3 p-lg-4">
        <div className="d-flex align-items-center justify-content-between mb-4">
          <div>
            <ol className="breadcrumb fs-sm mb-1">
              ...
              <li className="breadcrumb-item active" aria-current="page">Best Seller Product Control</li>
            </ol>
            <h4 className="main-title mb-0">Best Seller Product Control</h4>
          </div>
        ...
        <Modal show={showCreateModal} onHide={() => setShowCreateModal(false)}>
          <Modal.Header closeButton>
            <Modal.Title>Add Best seller product</Modal.Title>
          </Modal.Header>
          <Modal.Body>
        ...
        <Modal show={showDeleteModal} onHide={() => setShowDeleteModal(false)}>
          <Modal.Header closeButton>
            <Modal.Title>Delete Best seller product</Modal.Title>
          </Modal.Header>
          <Modal.Body>
