...
export default function SignupModal({ show, onClose, refetch }) {
      ...
      <Modal show={show} onHide={() => setShow(false)} centered>
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmit}>
            ...
            <Button variant="primary" className="btn-sign border-none bg-black" type="submit">Create Admin</Button>
          </Form>
          </Modal.Body>
